...
if (message.member.roles.get('537700464888643595') || message.member.roles.get('537705223301365781') || message.member.roles.get('537704565043363840')) {
    ...
    .addField("Команды для: <@&537705223301365781>","используются для настройки/выдачи")
    .addField("!админ *<юзер упоминание> <прислужник/дозорный> <дать/забрать>*","Выдает или забирает админку/модерку для указанного человека.")

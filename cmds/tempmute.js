...
if (!message.guild.roles.get("537700464888643595") && !message.guild.roles.get("537705223301365781") && !message.guild.roles.get("537704565043363840")) { message.reply('Хитрожопых наказываю'); return; }

...
module.exports.run = async (bot,message,args) => {
    ...
    if (randomfot != ramdomcat || randomfot != ramdomdog) { message.reply('Хуй знает что тебе надо'); return; }
    if (randomfot == ramdomcat) { let inforandom = "http://aws.random.cat/meow"; };  
    if (randomfot == ramdomcat) { let inforandom = "https://dog.ceo/api/breeds/image/random"; };  
